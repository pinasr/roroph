...
> *Maintainer's Note: `roroph` exclusively covers operational data starting 2024 to the present. This timeframe reflects the national shift toward digital standardization and integrated reporting mandated by Executive Order No. 55 (MIDP 2028). Prior to 2024, maritime records were often fragmented or non-digital; this dataset focuses on the current era of synchronized, machine-readable data. Moving forward, I am actively maintaining this dataset to reflect the current maritime landscape. If you are aware of newly established inter-island RoRo routes not yet captured, or routes that have ceased operations since 2024, please submit an issue.*
